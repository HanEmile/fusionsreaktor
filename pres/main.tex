  ...
  \section{Allgemeines}
    ...
    \subsection{Arten}
      ...
      \begin{frame}
        ...
        Tokamaks erzeugen die Verdrillung des Feldes durch \textbf{Induzieren eines
        elektrischen Stroms im Plasma}, Stellaratoren bewerkstelligen dies durch
        eine besondere, \textbf{komplizierte Formung ihrer Magnetspulen}.
      ...
      \begin{frame}
        ...
        \begin{itemize}
          \item \textit{stella} (lat. ``Stern'')
          \item Können mit deutlich höheren Dichten arbeiten als Tokamaks
          \item Dichte \( n \) hat den Vorteil einer steigenden Fusionsleistung
          (\( P_{Fusion} \propto n^{2} \))
          \item Nach zu langer laufzeit kommt es zu Verunreinigungen
        \end{itemize}
      ...
      \begin{frame}
        ...
        \begin{itemize}
          \item Ein \textbf{Plasma} aus Wasserstoffisotopen wird ein einem Torus
          von Starken Magnetfeldern eingeschlossen und auf 100 bis 150 Millionen
          Grad Celsius erhitzt.
          \item Die zurzeit leistungsfähigsten Anlagen zur untersuchung der
          Fusion basieren auf dem Tokamak Prinzip
        \end{itemize}
      \end{frame}
