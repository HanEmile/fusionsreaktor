...
\begin{document}
  ...
  \section{Stand der Forschung}
    ...
    \begin{frame}
      ...
      Die drei entscheidenden Größen ( Temperatur \( T \) , Teilchendichte \( n_e \)
      und Energieeinschlusszeit \( \tau_E \) ) wurden in den letzten 50 Jahren
      erheblich vergrößert und das Tripelprodukt \( T \cdot n_e \cdot \tau_E \)
